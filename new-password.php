    ...
    <main class="main">
        ...
        <div class="section jumbotron mb-0 h-100">
            ...
            <div class="container d-flex flex-column justify-content-center align-items-center h-100">              
                ...
                <form action="new-password.php" class="border shadow p-3 rounded" method="POST" autocomplete="off">
                    ...
                    <div class="form-group">
                        <input class="form-control button btn-success" type="submit" name="change-password" value="Change">
                    </div>
                </form>
                </div>
