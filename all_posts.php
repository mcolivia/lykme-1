...
//$stmt = $conn->prepare("SELECT * FROM article, author, category,users WHERE AND users.userid=author.user_id ORDER BY article_id DESC");
$stmt = $conn->prepare("SELECT * FROM article, author, category,users WHERE id_categorie = category_id AND users.userid=author.user_id AND article.id_author =users.userid  ORDER BY article_id DESC");
...
<body>
    ...
    <main class="main">
        ...
        <div class="jumbotron text-center mb-0">
            <h1 class="display-3 font-weight-normal text-muted">All Post</h1>
        </div>
        ...
        <div class="bg-white p-4">
            ...
            <div class="row ">
                ...
                <div class="col-lg-12 text-center mb-3">
                    <a class="btn btn-info" href="add_post.php">Add New Post</a>
                </div>
