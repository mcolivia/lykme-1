                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title">
                            <h2><?= $catID == "" ? "" : $category['category_name'] ?> Posts</h2>
                    ...
                    <?php foreach ($articles as $article) : ?>
                        ...
                        <div class="col-md-4">
                            <div class="post">
                                <a class="post-img" href="single_post.php?id=<?= $article['article_id'] ?>">
                                ...
                                <di class="post-body">
                                    ...
                                    <h3 class="post-title"><a href="single_post.php?id=<?= $article['article_id'] ?>"><?= $article['article_title'] ?></a></h3>
