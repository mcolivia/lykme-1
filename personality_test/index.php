...
<html lang="en">
    ...
    <div class="wrap" id="q1">
        ...
        <div class="d-flex justify-content-end pt-2"> <button class="btn btn-primary" id="next1" style="width:80px; height:35px;">Next <span class="fas fa-arrow-right"></span> </button> </div>
    </div>
    <div class="wrap" id="q2">
        ...
        <div class="d-flex justify-content-end pt-2"> <button class="btn btn-primary mx-3" id="back1" style="width:80px; height:35px;"><span class="fas fa-arrow-left pr-1"></span>Previous </button> <button class="btn btn-primary" style="width:80px; height:35px;" id="next2">Next <span class="fas fa-arrow-right"></span> </button> </div>
    </div>
    <div class="wrap" id="q3">
        ...
        <div class="d-flex justify-content-end pt-2"> <button class="btn btn-primary mx-3" style="width:80px; height:35px;" id="back2"> <span class="fas fa-arrow-left pr-2"></span>Previous </button> <button class="btn btn-primary" style="width:80px; height:35px;" id="next3">Next </button> </div>
    </div>
    <div class="wrap" id="q4">
        ...
        <div class="d-flex justify-content-end pt-2"> <button class="btn btn-primary mx-3" id="back3" style="width:80px; height:35px;"> <span class="fas fa-arrow-left pr-3"></span>Previous </button> <button class="btn btn-primary" style="width:80px; height:35px;" id="next4">Next </button> </div>
    </div>
    <div class="wrap" id="q5">
        ...
        <div class="d-flex justify-content-end pt-2"> <button class="btn btn-primary" style="width:80px; height:35px;" id="back4"> <span class="fas fa-arrow-left pr-4"></span>Previous </button> <button class="btn btn-primary" style="width:80px; height:35px;" id="next5"  onClick="myFunction();">Submit </button> </div>
    </div>
</div>
